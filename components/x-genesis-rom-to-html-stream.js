...
if ( !MarkI.StreamConverter ) {
    Components.utils.import("resource://gre/modules/XPCOMUtils.jsm");

    MarkI.StreamConverter = function() {};

    MarkI.StreamConverter.prototype = {
        ...
        _xpcom_factory: {
            createInstance: function(outer, iid) {
                ...
                if (iid.equals(Components.interfaces.nsISupports) ||
                    ...
                    return new MarkI.StreamConverter();
                }
...
if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([MarkI.StreamConverter]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([MarkI.StreamConverter]);
